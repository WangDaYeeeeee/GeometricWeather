...
class ScaleTransition(context: Context, attrs: AttributeSet?) : Transition(context, attrs) {
    ...
    override fun captureEndValues(transitionValues: TransitionValues) {
        ...
        transitionValues.values[PROPNAME_Y] = if (mShow) transitionValues.view.scaleY else 0f
    }
    ...
    companion object {
        ...
        private const val PROPNAME_X = "geometricweather:scale:x"
        private const val PROPNAME_Y = "geometricweather:scale:y"

        private val transitionProperties = arrayOf(PROPNAME_X, PROPNAME_Y)
    }
}
