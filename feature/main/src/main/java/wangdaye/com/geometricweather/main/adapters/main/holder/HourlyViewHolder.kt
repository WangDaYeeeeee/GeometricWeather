    ...
    override fun onBindView(
        ...
        if (tagList.size < 2) {
            ...
            tagView.adapter = TagAdapter(
                tagList,
                getColor(location, MaterialR.attr.colorOnPrimary),
                getColor(location, R.attr.colorOnSurface),
                getColor(location, MaterialR.attr.colorPrimary),
        ...
        precipitationBar.highlightColor = getColor(location, MaterialR.attr.colorPrimary)
