...
class DailyAirQualityAdapter(
    ...
    inner class ViewHolder(itemView: View) : AbsDailyTrendAdapter.ViewHolder(itemView) {
        ...
        fun onBindView(activity: GeoActivity, location: Location, position: Int) {
            ...
            val index = daily.airQuality.aqiIndex
            talkBackBuilder.append(", ").append(index).append(", ").append(daily.airQuality.aqiText)
            ...
            polylineAndHistogramView.setLineColors(
                daily.airQuality.getAqiColor(activity),
                daily.airQuality.getAqiColor(activity),
    ...
    init {
        ...
        for (i in weather.dailyForecast.indices.reversed()) {
            val index = weather.dailyForecast[i].airQuality.aqiIndex
    ...
    override fun getDisplayName(context: Context): String = context.getString(R.string.tag_aqi)

    override fun bindBackgroundForHost(host: TrendRecyclerView) {
        val keyLineList = ArrayList<TrendRecyclerView.KeyLine>()
        keyLineList.add(
            TrendRecyclerView.KeyLine(
                AirQuality.AQI_INDEX_1.toFloat(),
                AirQuality.AQI_INDEX_1.toString(),
        ...
        keyLineList.add(
            TrendRecyclerView.KeyLine(
                AirQuality.AQI_INDEX_3.toFloat(),
                AirQuality.AQI_INDEX_3.toString(),
        ...
        keyLineList.add(
            TrendRecyclerView.KeyLine(
                AirQuality.AQI_INDEX_5.toFloat(),
                AirQuality.AQI_INDEX_5.toString(),
