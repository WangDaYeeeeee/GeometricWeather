...
class TagAdapter(
    ...
    private val mTagList: MutableList<Tag> = tagList.toMutableList()
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            mTagView.setOnClickListener {
                var consumed = false
                if (mListener != null) {
                    consumed = mListener.onItemChecked(!mTagView.isChecked, mCheckedIndex, adapterPosition)
                }
