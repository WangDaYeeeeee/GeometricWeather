...
class ClockDayWeekWidgetIMP : AbstractRemoteViewsPresenter() {
    ...
    companion object {
        ...
        fun getRemoteViews(
            ...
            views.setTextViewText(R.id.widget_clock_day_week_week_1, WidgetHelper.getDailyWeek(context, weather, 0))
            views.setTextViewText(R.id.widget_clock_day_week_week_2, WidgetHelper.getDailyWeek(context, weather, 1))
            views.setTextViewText(R.id.widget_clock_day_week_week_3, WidgetHelper.getDailyWeek(context, weather, 2))
            views.setTextViewText(R.id.widget_clock_day_week_week_4, WidgetHelper.getDailyWeek(context, weather, 3))
            views.setTextViewText(R.id.widget_clock_day_week_week_5, WidgetHelper.getDailyWeek(context, weather, 4))
            views.setTextViewText(R.id.widget_clock_day_week_temp_1, getTemp(context, weather, 0, temperatureUnit))
            views.setTextViewText(R.id.widget_clock_day_week_temp_2, getTemp(context, weather, 1, temperatureUnit))
            views.setTextViewText(R.id.widget_clock_day_week_temp_3, getTemp(context, weather, 2, temperatureUnit))
            views.setTextViewText(R.id.widget_clock_day_week_temp_4, getTemp(context, weather, 3, temperatureUnit))
            views.setTextViewText(R.id.widget_clock_day_week_temp_5, getTemp(context, weather, 4, temperatureUnit))
