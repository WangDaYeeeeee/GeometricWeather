...
class Snackbar private constructor(
    ...
    open class SnackbarLayout @JvmOverloads constructor(
        ...
        fun getMessageView(): TextView = mMessageView

        fun getActionView(): Button = mActionView
    ...
    class CardSnackbarLayout @JvmOverloads constructor(
        context: Context,
        attrs: AttributeSet? = null
    ) : SnackbarLayout(context, attrs) {
