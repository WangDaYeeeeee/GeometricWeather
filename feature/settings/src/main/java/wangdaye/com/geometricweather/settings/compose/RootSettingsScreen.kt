...
import wangdaye.com.geometricweather.settings.SettingsAppBridge
    ...
    PreferenceScreen(paddingValues = paddingValues) {
                ...
                onValueChanged = {
                    ...
                    if (!it) {
                        postNotificationPermissionEnsurer {
                            SettingsAppBridge.callbacks.resetNormalBackgroundTask(context, false)
        ...
        clickablePreferenceItem(R.string.settings_title_live_wallpaper) { id ->
            PreferenceView(
                ...
                SettingsAppBridge.callbacks.startLiveWallpaper(context)
            }
        }
        ...
        timePickerPreferenceItem(R.string.settings_title_forecast_today_time) { id ->
            TimePickerPreferenceView(
                ...
                onValueChanged = {
                    ...
                    SettingsAppBridge.callbacks.resetTodayForecastBackgroundTask(
                        context,
                        false,
                        false
                    )
        ...
        timePickerPreferenceItem(R.string.settings_title_forecast_tomorrow_time) { id ->
            TimePickerPreferenceView(
                ...
                onValueChanged = {
                    ...
                    SettingsAppBridge.callbacks.resetTomorrowForecastBackgroundTask(
                        context,
                        false,
                        false
                    )
        ...
        listPreferenceItem(R.string.settings_title_week_icon_mode) { id ->
            ListPreferenceView(
                ...
                onValueChanged = {
                    ...
                    SettingsAppBridge.callbacks.resetNormalBackgroundTask(context, true)
                },
            )
        }
        ...
        SettingsAppBridge.callbacks.enabledWidgetConfigLinks(context).forEach { link ->
            clickablePreferenceItem(link.titleRes) {
                PreferenceView(title = stringResource(it)) {
                    link.onClick(context)
                }
            }
        }
            ...
            CheckboxPreferenceView(
                ...
                onValueChanged = {
                    ...
                    if (it) { // open notification.
                        ...
                        SettingsAppBridge.callbacks.cancelNotification(context)
                        SettingsAppBridge.callbacks.resetNormalBackgroundTask(context, false)
                    }
                }
            )
