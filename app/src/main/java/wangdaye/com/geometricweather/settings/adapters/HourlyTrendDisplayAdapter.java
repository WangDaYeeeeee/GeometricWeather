...
public class HourlyTrendDisplayAdapter extends RecyclerView.Adapter<HourlyTrendDisplayAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void onBindView(HourlyTrendDisplay hourlyTrendDisplay) {
            title.setText(hourlyTrendDisplay.getTagName(title.getContext()));
