...
class Temperature(
    ...
    companion object {
        ...
        /**
         * Wired from [wangdaye.com.geometricweather.settings.SettingsManager] so domain
         * does not depend on the settings store.
         */
        @JvmStatic
        @Volatile
        var exchangeDayNightTempEnabled: (Context) -> Boolean = { false }
        ...
        fun getTrendTemperature(
            ...
            return getTrendTemperature(
                ...
                day,
                unit,
                exchangeDayNightTempEnabled(context)
            )
        }
