...
class SettingsManager private constructor(context: Context) {
    ...
    var iconProvider: String
        ...
        get() = config.getString("iconProvider", appContext.packageName) ?: ""
    ...
    val providerAccuWeatherKey: String
        get() = getProviderSettingValue(
            ...
            defaultValue = wangdaye.com.geometricweather.data.BuildConfig.ACCU_WEATHER_KEY,
        )

    val providerAccuCurrentKey: String
        get() = getProviderSettingValue(
            customValue = customAccuCurrentKey,
            defaultValue = wangdaye.com.geometricweather.data.BuildConfig.ACCU_CURRENT_KEY,
        )

    val providerAccuAqiKey: String
        get() = getProviderSettingValue(
            customValue = customAccuAqiKey,
            defaultValue = wangdaye.com.geometricweather.data.BuildConfig.ACCU_AQI_KEY,
        )

    val providerOwmKey: String
        get() = getProviderSettingValue(
            customValue = customOwmKey,
            defaultValue = wangdaye.com.geometricweather.data.BuildConfig.OWM_KEY,
        )

    val providerBaiduIpLocationAk: String
        get() = getProviderSettingValue(
            customValue = customBaiduIpLocationAk,
            defaultValue = wangdaye.com.geometricweather.data.BuildConfig.BAIDU_IP_LOCATION_AK,
        )

    val providerMfWsftKey: String
        get() = getProviderSettingValue(
            customValue = customMfWsftKey,
            defaultValue = wangdaye.com.geometricweather.data.BuildConfig.MF_WSFT_KEY,
        )

    val providerIqaAirParifKey: String
        get() = getProviderSettingValue(
            customValue = customIqaAirParifKey,
            defaultValue = wangdaye.com.geometricweather.data.BuildConfig.IQA_AIR_PARIF_KEY,
        )

    val providerIqaAtmoAuraKey: String
        get() = getProviderSettingValue(
            customValue = customIqaAtmoAuraKey,
            defaultValue = wangdaye.com.geometricweather.data.BuildConfig.IQA_ATMO_AURA_KEY,
        )
