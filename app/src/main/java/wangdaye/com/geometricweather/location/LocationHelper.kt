...
class LocationHelper @Inject constructor(
    ...
    fun requestLocation(
        ...
        service.requestLocation(context, object : LocationService.LocationCallback {
    ...
    private fun requestAvailableWeatherLocation(
        ...
        service.requestLocation(context, location, object : WeatherService.RequestLocationCallback {
    ...
    fun getPermissions(context: Context): Array<String> {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.R) {
            val qPermissions = Array(permissions.size + 1) { "" }
