...
class DayWidgetConfigActivity : AbstractWidgetConfigActivity() {
    override fun initData() {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O) {
            ...
            viewTypes = arrayOf(
                widgetStyles[0], widgetStyles[1], widgetStyles[2], widgetStyles[3],
                widgetStyles[4], widgetStyles[5], widgetStyles[6], widgetStyles[7], widgetStyles[9]
            )
            viewTypeValues = arrayOf(
                widgetStyleValues[0], widgetStyleValues[1], widgetStyleValues[2], widgetStyleValues[3],
                widgetStyleValues[4], widgetStyleValues[5], widgetStyleValues[6], widgetStyleValues[7],
                widgetStyleValues[9]
            )
        }
    }
