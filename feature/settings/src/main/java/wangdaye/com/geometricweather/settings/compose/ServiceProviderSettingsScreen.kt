...
fun ServiceProviderSettingsScreen(
    ...
    listPreferenceItem(R.string.settings_title_location_service) { id ->
        ...
        if (wangdaye.com.geometricweather.settings.SettingsAppBridge.callbacks.restrictLocationProvidersForStoreFlavor) {
        ...
        ListPreferenceView(
            ...
            onValueChanged = { sourceId ->
                ...
                SnackbarHelper.showSnackbar(
                    ...
                    GeoApp.activityHost.recreateAllActivities()
                }
            }
        )
    }
