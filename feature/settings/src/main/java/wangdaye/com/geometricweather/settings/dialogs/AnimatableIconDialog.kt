...
object AnimatableIconDialog {
    ...
    @JvmStatic
    fun show(context: Context, code: WeatherCode, daytime: Boolean, provider: ResourceProvider) {
    ...
    private fun initWidget(view: View, code: WeatherCode, daytime: Boolean, provider: ResourceProvider) {
